 ...
 * @author MODOFWAR
 */
public class PerusahaanLogin extends javax.swing.JFrame {

    /**
     * Creates new form PerusahaanLogin
     */
    public PerusahaanLogin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerusahaanLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerusahaanLogin().setVisible(true);
            }
        });
    }
